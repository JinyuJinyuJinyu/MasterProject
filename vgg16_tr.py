...
def main(idx):
    ...
    vgg = VGG16(1000).to(device)

    optis = [optim.SGD(vgg.parameters(), lr=0.001, momentum=0.9),optim.Adam(vgg.parameters(),eps=1e-7)]
    f_name = ['SGD_vgg16_tr.json','adam_vgg16_tr.json']
    ...
    for epoch in range(1, epochs + 1):
        ...
        if True:
            ...
            confusion_mtx = torch.zeros((1000, 1000)).cuda()
            val_info = {}
            losses = 0
            mini_batch_count = 0
            vgg.train(False)
